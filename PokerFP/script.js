...
// --- DOM Elements ---
const playerCardEls = [document.getElementById('player-card-1'), document.getElementById('player-card-2')];
const aiCardEls = document.querySelectorAll('.ai-cards .card');
const commCardEls = [
